...
tests = [
    ...
    ("трансфер Иван Петров от Левски София в ЦСКА София 2026-03-10", "transfer_player"),
    ("трансфер Иван Петров от Левски София в ЦСКА София", "transfer_player"),
    ("трансферирай играч Иван Петров от Левски София в клуб ЦСКА София", "transfer_player"),
    ("трансферирай играч Иван в клуб ЦСКА", "transfer_player"),
    ("покажи трансфери на играч Иван Петров", "show_transfers_player"),
    ("покажи трансфери на клуб Левски София", "show_transfers_club"),
